...
public class ModeratorTest {
    public static void main(String[] args) throws SQLException {
        ...
        DoctorRepository doctorRepository = new DoctorRepository(dbClient);
        ArrayList<DoctorEntity> doctors = doctorRepository.getAllDoctors();
        ...
        doctorRepository = new DoctorRepository(dbClient);
