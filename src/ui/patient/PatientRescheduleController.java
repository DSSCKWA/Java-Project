...
public class PatientRescheduleController implements Initializable {
    private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            doctors.add(Session.getClient().getDoctorById(Session.getVisit().getDoctor().getId()));
...

                {
                    scheduleButton.setOnAction((ActionEvent event) -> {
                        ...
                        try {
                            ...
                            Visit v = Session.getVisit();
                            v.setStatus(VisitStatus.PENDING_WAITING_APPROVAL);
                            v.setDate(tfDate.getValue());
                            v.setTime(newVisit.getStartTime());
                            v.setDuration((int) Duration.between(newVisit.getStartTime(), newVisit.getEndTime()).toMinutes());

                            Session.getClient().updateVisit(v);
                        ...
                        popup.setTitle("Visit rescheduled successfully!");
                        Label popupLabel = new Label("Your visit has been rescheduled successfully.");
